    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < cmd_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            if (pcmd->UserCallback != nullptr)
            {
                ...
                // See issues:
                //     https://github.com/thedmd/imgui-node-editor/issues/282
                // and https://github.com/thedmd/imgui-node-editor/issues/205
                // + partial solution: https://github.com/thedmd/imgui-node-editor/commit/af7fa51bb9d68c9b44477c341f13a7dadee3e359
                ...
                if (pcmd->UserCallback == ImDrawCallback_ResetRenderState)
                    ImGui_ImplVulkan_SetupRenderState(draw_data, pipeline, command_buffer, rb, fb_width, fb_height);
                else if (isUserCallbackAddressValid)
